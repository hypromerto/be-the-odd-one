...
export default function RoomContent({ initialRoomState, roomId, currentUserId }: RoomContentProps) {
    ...
    return (
        <div className="flex flex-col md:flex-row gap-4 w-full max-w-7xl mx-auto">
            <Card className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg w-full md:w-3/4">
            ...
            {roomState.gameState !== 'waiting' && roomState.gameState !== 'theme_input' && roomState.gameState !== 'game_over' && (
